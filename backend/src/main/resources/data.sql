...
(
    ...
    username           VARCHAR(250 char) NOT NULL,
    password           VARCHAR(250 char) NOT NULL,
    email              VARCHAR(250 char) NOT NULL,
    cell_phone         VARCHAR(11 char),
    is_admin           VARCHAR(5 char),
    created_by         VARCHAR(250 char) NOT NULL,
    created_date       DATETIME2         NOT NULL,
    last_modified_by   VARCHAR(250 char) NOT NULL,
